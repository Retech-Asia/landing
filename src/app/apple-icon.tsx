...
// Image metadata — Apple requires 180x180 PNG for touch icons.
export const size = { width: 180, height: 180 };
export const contentType = "image/png";

// Apple-touch-icon: solid brand background with the actual Retech hexagonal-R
// logo centered. Apple applies its own rounded-corner mask at install time,
// so we render a filled square and let iOS clip it.
    ...
    (
      <div
        style={{
          ...
          background: "linear-gradient(135deg, #208535 0%, #186B2B 100%)",
        }}
      >
        <svg
          width="120"
