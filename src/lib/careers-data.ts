...
export const jobListings: JobListing[] = [
  {
    ...
    benefits: [
      "Competitive salary + 13th-month pay (Vietnamese labor law)",
      "Tet bonus and statutory Vietnamese public holidays",
      "Premium health insurance + annual wellness allowance",
      "Lunch allowance and modern office in HCMC (or remote-friendly)",
      "Annual learning budget for courses, certs, and conferences",
      "Flexible hours, hybrid work model, English-training stipend",
    ],
  },
  {
