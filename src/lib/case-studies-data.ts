...
export const caseStudies: CaseStudy[] = [
  {
    ...
    beforeAfter: [
      { metric: { en: "Dashboard Switching", vi: "Chuyển Dashboard" }, before: { en: "4 tools", vi: "4 công cụ" }, after: { en: "1 unified view", vi: "1 góc nhìn thống nhất" }, improvement: { en: "-75%", vi: "-75%" } },
    ...
    timelineDuration: { en: "7 months", vi: "7 tháng" },
  ...
  },
  {
    ...
    beforeAfter: [
      { metric: { en: "Data Processing", vi: "Xử lý Dữ liệu" }, before: { en: "45 min/report", vi: "45 phút/báo cáo" }, after: { en: "3 min/report", vi: "3 phút/báo cáo" }, improvement: { en: "-93%", vi: "-93%" } },
      { metric: { en: "Dashboard Load", vi: "Tải Dashboard" }, before: { en: "8.5s", vi: "8.5s" }, after: { en: "1.4s", vi: "1.4s" }, improvement: { en: "-84%", vi: "-84%" } },
      { metric: { en: "User Adoption", vi: "Áp dụng Người dùng" }, before: { en: "35%", vi: "35%" }, after: { en: "89%", vi: "89%" }, improvement: { en: "+154%", vi: "+154%" } },
      { metric: { en: "Error Rate", vi: "Tỷ lệ Lỗi" }, before: { en: "12%", vi: "12%" }, after: { en: "0.5%", vi: "0.5%" }, improvement: { en: "-96%", vi: "-96%" } },
    ],
    timeline: [
    ...
    timelineDuration: { en: "10 months", vi: "10 tháng" },
  ...
  },
  {
    ...
    timelineDuration: { en: "12 months", vi: "12 tháng" },
  ...
  },
  {
    ...
    timelineDuration: { en: "6 months", vi: "6 tháng" },
