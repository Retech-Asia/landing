      ...
      <AnimatePresence>
        {open && (
          <motion.span
            ...
            role="tooltip"
            className={cn(
              "absolute z-[var(--z-dropdown)] max-w-[220px] rounded-lg px-3 py-2 text-xs leading-relaxed text-white bg-brand-dark shadow-lg pointer-events-none whitespace-normal",
